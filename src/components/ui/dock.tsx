    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={cn(
            "absolute -top-8 left-1/2 w-fit whitespace-pre rounded-md border border-white/10 bg-black/90 px-2 py-1 text-xs text-foreground shadow-lg backdrop-blur-sm",
            className
          )}
          role="tooltip"
          style={{ x: "-50%" }}
